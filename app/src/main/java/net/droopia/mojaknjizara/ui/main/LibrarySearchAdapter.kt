...
package net.droopia.mojaknjizara.ui.main
...
import net.droopia.mojaknjizara.ui.main.LibrarySearchAdapter.SearchViewHolder


const val EXTRA_OPEN_LIBRARY_SEARCH = "open_library_search_extra"


class LibrarySearchAdapter() : ListAdapter<Book, SearchViewHolder>(SEARCH_COMPARATOR) {
